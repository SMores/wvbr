...
Refinery::Images.configure do |config|
  ...
  config.dragonfly_secret = "1b4662e69fa6a2bc4609fe68d06574eed35f09013752bce7"
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/shanewmoore/Documents/Sites/wvbr/public/system/refinery/images"
